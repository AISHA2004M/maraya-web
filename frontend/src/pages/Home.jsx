/**
 * Home — Pure Minimalist Luxury Boutique (Zara / Celine / Saint Laurent Standard)
 * ===============================================================================
 * Ultra-clean, uncluttered, pure high-fashion boutique:
 * - Fullscreen Cinematic Editorial Hero with clean typography.
 * - Pristine Product Gallery with category filters.
 * - Zero filler sections, zero clutter.
 */
...
export default function Home() {
    ...
    api.get(`/products/brands/slug/${brand_slug}`)
      ...
      .catch((err) => {
        ...
        setBrand({
          ...
          hero_subtitle: "New Season Collection · Autumn/Winter Edition",
  ...
  return (
    <div className="min-h-screen bg-white font-sans text-primary selection:bg-black selection:text-white">
      ...
      {/* 1. MINIMALIST LUXURY HERO (Fullscreen Pure High Fashion) */}
