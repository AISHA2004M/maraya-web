        ...
        <div className="grid lg:grid-cols-[1fr_3.5fr] gap-10 items-start">
          ...
          <div className="space-y-6 lg:sticky top-28">
            <div
              ...
              onDrop={handleDrop}
              className={`relative border-2 border-dashed rounded-sm bg-white dark:bg-neutral-900 transition-all duration-300 p-8 flex flex-col items-center justify-center text-center min-h-[350px] overflow-hidden ${
                imagePreview ? "border-rule" : "border-neutral-300 hover:border-black dark:hover:border-white"
              }`}
            >
              {imagePreview ? (
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-1">
                    <p className="text-xs font-semibold text-primary">{t("drag_drop_search")}</p>
                    <p className="text-[10px] text-secondary">JPG, PNG, WebP · max 10MB</p>
                  </div>
                  <label className="btn-black inline-block py-2 px-6 text-[9.5px] font-bold tracking-widest uppercase cursor-pointer rounded-none">
                    {language === "ar" ? "تصفح الصور" : "Browse Image"}
                    <input
                      type="file"
                      accept="image/*"
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
                      {filteredResults.map((product) => {
                        ...
                        const productUrl = `${brandPath}/product/${product.id}`;
